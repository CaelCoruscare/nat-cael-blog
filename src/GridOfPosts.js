...
const posts = [
  ...
  {title: "Secret Tunnel, Secret Tunnnnnel"
    ...
    ,par0: "The robins of New Zealand are so cute. They hop around on their giant legs, and look up at you with their puppy-dog eyes. Their body, not including the legs, is a little smaller than a tennis ball."
    ,par1: "Unlike other birds in New Zealand, not only are they very friendly and inquisitive, they are also happy to jump around underfoot. You end up a little worried of walking on them, like an overly-friendly dog with bad spacial awareness. If you walk, they will occasionally jump up and eat an insect that you kick up, much like the fantails. But if you stand still they hop around you in circles, curious of the featherless bipeds walking through their patch of forest. On Ulva island, one of them hopped onto my shoe while I was sitting. For this reason, they were pretty rare outside of heavily predator controlled areas (where New Zealanders spend massive amounts of money on trapping and poisoning invasive mammal predators). If you want to support these friendly little birds, "
    ,par2: ""
    }
